...
We've created a pre-customized version of the node_installer script from Findora which we host publicly on our [github page here](https://github.com/easy-node-one/findora-validator-scripts).
