...
## Using a Temporary Wallet
The best method to avoid double signing is to setup a new validator wallet and private key doing a normal installation of Findora. When the docker container is synced up you can then:
