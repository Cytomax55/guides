...
```bash
# Below is an example of how this command should be sent. Replace the fake mnemonic in it with the mnemonic phrase in your tmp.gen.keypair file:
...
See [this link](https://wiki.findora.org/docs/guides/auto-setup#download-and-run-the-automated-setup-script) to get the most updated version of the **node_init_mainnet.sh** script to run. Simply right click the link and copy the shortcut to use in the commands below:
