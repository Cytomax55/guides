...
To use the code below simply replace the ssh-rsa key with your id_rsa.pub key and set the username you'd like (currently `serficefindora` in this example). The cloud-init does take a few minutes to run and if you're installing findora you'll need to reconnect and verify your user is in the docker group.
