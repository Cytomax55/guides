...
runcmd:
  ...
  - wget https://raw.githubusercontent.com/easy-node-one/findora-validator-scripts/main/node_init.sh -O /home/serviceuser/node_init.sh
  - git clone https://github.com/easy-node-one/validatortoolbox.git /home/serviceuser/validatortoolbox
  - pip3 install 
  ```
