...
```text
cd ~/ && wget https://raw.githubusercontent.com/easy-node-one/findora-validator-scripts/main/node_init_mainnet.sh -O /home/serviceuser/node_init.sh && bash -x node_init.sh
```
